...
function datSAVEvg(ELdat,PHdat,EXP) %#ok<INUSD,*NASGU> 
...
if nargin<3, save(['DATvg\' Sexp.Stype Snum Sexp.PhaseNow '.mat'],'ELdat','PHdat','Sexp');
else save(['DATvg\' Sexp.Stype Snum Sexp.PhaseNow '.mat'],'EXP','ELdat','PHdat','Sexp'); end
